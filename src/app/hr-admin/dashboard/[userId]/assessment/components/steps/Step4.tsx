...
interface Step4Props {
  ...
  showReassessmentSplit: boolean;
  businessDaysRemaining: number;
  handleProceedWithHire: () => void;
  handleProceedWithReassessment: () => void;
  activeTab: string;
  setActiveTab: (tab: string) => void;
  currentStep: number;
  showReassessmentInfoModal: boolean;
  setShowReassessmentInfoModal: (v: boolean) => void;
  setShowReassessmentSplit: (v: boolean) => void;
      ...
      {!showReassessmentSplit && (
        <div className="bg-white rounded-xl border border-gray-200 p-8 mb-8">
          ...
          <div className="flex flex-col items-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-center mb-2 text-black" style={{ fontFamily: "Poppins, sans-serif" }}>
              Preliminary Decision Notice Sent Successfully
            </h2>
            <div className="text-center mb-4" style={{ fontFamily: "Poppins, sans-serif", color: "#595959" }}>
            ...
            <div className="w-full flex flex-col items-center">
              <div className="flex flex-col items-center bg-red-50 rounded-xl px-12 py-4 mb-4 border border-red-100">
                <span className="text-4xl font-bold" style={{ fontFamily: "Poppins, sans-serif", color: "#E54747" }}>
                  {businessDaysRemaining}
                </span>
                <div className="text-lg" style={{ fontFamily: "Poppins, sans-serif", color: "#E54747" }}>
          ...
          <div className="w-full bg-gray-50 rounded-xl p-6 mb-6 border border-gray-200">
            <div className="font-semibold mb-2 text-black" style={{ fontFamily: "Poppins, sans-serif" }}>
              Next Steps:
            </div>
      ...
      {!showReassessmentSplit && showReassessmentInfoModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white rounded-xl shadow-lg max-w-2xl w-full p-10 relative border border-gray-200">
            <h2 className="text-2xl font-bold mb-6 text-black" style={{ fontFamily: "Poppins, sans-serif" }}>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm text-blue-800">
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong>At least 5 business days</strong> to provide mitigating evidence that speaks to their character and fitness to perform the job
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>
                      <strong>Additional 5 business days</strong> if the applicant intends to gather and deliver information disputing the accuracy of the criminal history report
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="flex-1 bg-white rounded-xl shadow p-8 border border-gray-200 max-h-[600px] overflow-y-auto">
            ...
            {loadingCandidateData ? (
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold mb-4 text-black" style={{ fontFamily: "Poppins, sans-serif" }}>
                  Profile is Private
                </h3>
