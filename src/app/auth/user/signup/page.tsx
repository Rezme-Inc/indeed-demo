    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-semibold text-black mb-2">Create Your Account</h1>
          <p className="text-secondary">Join us to build your restorative record</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="••••••••"
            />
            <p className="mt-1 text-sm text-secondary">Must be at least 6 characters</p>
          </div>
          ...
          <div className="text-center">
            <p className="text-secondary">
              ...
              <Link href="/auth/user/login" className="text-primary hover:text-red-600 font-medium transition-colors">
                Sign in
              </Link>
            </p>
          </div>
